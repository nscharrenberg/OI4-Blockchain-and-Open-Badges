...
class ValidateBadgeAwardCard extends React.Component {
  constructor(props) {
    ...
    handleIssueValidation(event) {
        event.preventDefault();
        this.props.handleIssueV(this.state.thisBadge, this.state.validatorId);
    }  
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary className={classes.detailRow} expandIcon={<ExpandMoreIcon />}>
          ...
          <div className={classes.columnButton}>
            <Button variant="raised" onClick={this.handleIssueValidation.bind(this)} color="success" style={{backgroundColor: '#00C853'}}><i class="material-icons" style={{color:'white'}}>done</i></Button>
          </div>
          <div className={classes.columnButton}>
        ...
        <ExpansionPanelDetails className={classes.details}>
          ...
          <Typography variant="subheading" color="textSecondary">
              ...
              <Button onClick={this.handleIssueValidation.bind(this)} className={classes.columnButton} variant="raised" color="success" style={{backgroundColor: '#00C853'}}><i class="material-icons" style={{color:'white'}}>done</i></Button>
